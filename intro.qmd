...
Eye colour is a `r mcq(c("discrete numerical variable", "continuous numerical variable", "ordinal categorical variable", answer = "nominal categorical variable"))`

Temperature is a `r mcq(c("discrete numerical variable", "ordinal categorical variable", "nominal categorical variable", answer = "continuous numerical variable"))`

The number of heads in a series of coin flips is a `r mcq(c( "continuous numerical variable", "ordinal categorical variable", "nominal categorical variable", answer = "discrete numerical variable"))`

Education level is a `r mcq(c("discrete numerical variable", "continuous numerical variable", "nominal categorical variable", answer = "ordinal categorical variable"))`

Postal Code is a `r mcq(c("discrete numerical variable", "continuous numerical variable", "ordinal categorical variable", answer = "nominal categorical variable"))`

Income salary is a `r mcq(c("discrete numerical variable", "ordinal categorical variable", "nominal categorical variable", answer = "continuous numerical variable"))`

Number of calls per day is a `r mcq(c("discrete numerical variable", "continuous numerical variable", "ordinal categorical variable", "nominal categorical variable", answer = "discrete numerical variable"))`
