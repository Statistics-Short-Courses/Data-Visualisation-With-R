...
ggplot(data=rice, aes(x=Plant.height..cm.))+
  ...
  theme_bw()
```
We can make the histogram even more informative by filling in the colour by sowing method. Do the plant heights differ between 

```{r, message=FALSE, warning = FALSE}
ggplot(data=rice, aes(x=Plant.height..cm., fill=Sowing.method))+
...
```{r, message=FALSE, warning = FALSE}
ggplot(data=rice, aes(x=Plant.height..cm., col=Sowing.method))+
