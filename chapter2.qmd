...
#    Use a bin width of 100, label the x-axis "Body Mass of Penguins (g)" and the 
...
#    Label the x-axis "Body Mass of Penguins (g)" and the y-axis as "Frequency".
...
ggplot(data=clean_penguins, 
  ...
  labs(x="Body Mass of Penguins (g)", y="Frequency")+ 
  theme_bw()
...
#    Label the axes as "Body Mass of Penguins (g)" and
#    "Flipper Length of Penguins (mm)", and apply a black-and-white theme.
```
...
ggplot(clean_penguins, aes(x=flipper_length_mm, y=body_mass_g))+
  ...
  labs(x="Flipper Length of Penguins (mm)", y="Body Mass of Penguins (g)")+
  theme_bw()
